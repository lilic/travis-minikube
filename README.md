...
Quick example of running [minikube](https://github.com/kubernetes/minikube) on [Travis CI](https://travis-ci.org/) with [Kubernetes](https://github.com/kubernetes/kubernetes) version `1.16.0`.
...
To switch Kubernetes cluster versions just replace the `1.16.0` version in the `.travis.yml` file.
