...
Quick example of running [minikube](https://github.com/kubernetes/minikube) on [Travis CI](https://travis-ci.org/) with [Kubernetes](https://github.com/kubernetes/kubernetes).
...
To switch Kubernetes cluster versions just replace the `1.18.2` version in the `.travis.yml` file.

To switch Minikube versions just replace the `1.9.2` version in the `.travis.yml` file.
